...
class Custom_CustomOrderNumber_StartController extends Mage_Adminhtml_Controller_Action {
	...
	public function updateAction() {
		...
		Mage::log("Running update for Custom_CustomOrderNumber...");
		
		$collection = Mage::getModel('eav/entity_type')->getCollection();
		$override = Mage::helper('customordernumber')->isOverrideEnabled();
		...
		$objects = array(
		'order' => Mage::helper('customordernumber')->getOrderNumber(),
		'invoice' => Mage::helper('customordernumber')->getInvoiceNumber(),
		'shipment' => Mage::helper('customordernumber')->getShipmentNumber(),
		'creditmemo' => Mage::helper('customordernumber')->getCreditNumber());
